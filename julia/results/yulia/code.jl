...
if previous == 1
    d = load("/Users/iuliia/Desktop/results_yulia/previousParameterization.jld")
...
#/Users/iuliia/Desktop/results_yulia/
filename1 = string("/Users/iuliia/Desktop/results_yulia/results_",n_g,"_groups_τW=",τ_w,"_τE=",τ_e,"_A=",round(A,digits=2),"_α=",round(α,digits=2),"_β=",round(β,digits=2),"_η=",round(η,digits=2),"_σ=",round(σ,digits=2),".jld")
...
filename2 = string("/Users/iuliia/Desktop/results_yulia/previousParameterization.jld")
