...
d = load("C:/Users/iuliia/Desktop/teachers/julia/results_new/results_2_groups_tauW=[0.0 0.0]_tauE=[0.0 0.0]_beta-to-sigma=0.94_A=2.0.jld")
...
savefig(plt1,"C:/Users/iuliia/Desktop/teachers/julia/results_new/occupational_choice_new_grid_tauW_"*string(τ_w[1,1])*"_tauE_"*string(τ_e[1,1])*"_beta-to-sigma="*string(round(β/σ,digits=2))*"_A="*string(round(A,digits=2))*".eps")
...
savefig(plt2,"C:/Users/iuliia/Desktop/teachers/julia/results_new/fixed_point_H_T_new_grid_tauW_"*string(τ_w[1,1])*"_tauE_"*string(τ_e[1,1])*"_beta-to-sigma="*string(round(β/σ,digits=2))*"_A="*string(round(A,digits=2))*".eps")
...
savefig(plt3,"C:/Users/iuliia/Desktop/teachers/julia/results_new/measures_H_T_new_grid_tauW_"*string(τ_w[1,1])*"_tauE_"*string(τ_e[1,1])*"_beta-to-sigma="*string(round(β/σ,digits=2))*"_A="*string(round(A,digits=2))*".eps")
# Plot occupational threshold for different values of β and σ (and constant τ, A,...)
d1 = load("C:/Users/iuliia/Desktop/teachers/julia/results_new/results_2_groups_tauW=[0.0 0.0]_tauE=[0.0 0.0]_beta-to-sigma=0.94_A=2.0.jld")
...
plt14 = plot(a_grid,a_O_thresh[:,1,1],grid=:none,label=latexstring("\\frac{\\beta}{\\sigma} = "*string(round(β/σ,digits=2))))
...
plt7 = plot(a_grid,f_1[:,1,1],grid=:none,label=latexstring("\\frac{\\beta}{\\sigma} = "*string(round(β/σ,digits=2))),xlabel=L"$a$",ylabel="fraction of teachers",legend=:topright)
...
d2 = load("C:/Users/iuliia/Desktop/teachers/julia/results_new/results_2_groups_tauW=[0.0 0.0]_tauE=[0.0 0.0]_beta-to-sigma=1.0_A=2.0.jld")
...
plt14 = plot!(plt14,a_grid,a_O_thresh[:,1,1],grid=:none,label=latexstring("\\frac{\\beta}{\\sigma} = "*string(round(β/σ,digits=2))))
...
plt7 = plot!(plt7,a_grid,f_1[:,1,1],grid=:none,label=latexstring("\\frac{\\beta}{\\sigma} = "*string(round(β/σ,digits=2))),xlabel=L"$a$",ylabel=L"fraction of teachers",legend=:topright)
betasigma[2]=β/σ
fracteach[2]=sum(mass_T[1,:])/(sum(mass_T[1,:])+sum(mass_O[1,:]))
# plt5 = scatter!(β/σ,sum(mass_T[1,:])/(sum(mass_T[1,:])+sum(mass_O[1,:])),color=:blue)
d3 = load("C:/Users/iuliia/Desktop/teachers/julia/results_new/results_2_groups_tauW=[0.0 0.0]_tauE=[0.0 0.0]_beta-to-sigma=1.06_A=2.0.jld")
...
# plt5 = scatter!(β/σ,sum(mass_T[1,:])/(sum(mass_T[1,:])+sum(mass_O[1,:])),color=:blue)
d5 = load("C:/Users/iuliia/Desktop/teachers/julia/results_new/results_2_groups_tauW=[0.0 0.0]_tauE=[0.0 0.0]_beta-to-sigma=1.15_A=2.0.jld")
...
# plt5 = scatter!(β/σ,sum(mass_T[1,:])/(sum(mass_T[1,:])+sum(mass_O[1,:])),color=:blue)
d6 = load("C:/Users/iuliia/Desktop/teachers/julia/results_new/results_2_groups_tauW=[0.0 0.0]_tauE=[0.0 0.0]_beta-to-sigma=1.25_A=2.0.jld")
...
plt14 = plot!(plt14,a_grid,a_O_thresh[:,1,1],grid=:none,label=latexstring("\\frac{\\beta}{\\sigma} = "*string(round(β/σ,digits=2))),xlabel=L"$a^O$",ylabel=L"$\bar{a}^T(a^O)$",legend=:topleft)
plt6 = plot!(plt6,H_grid,HH_T[1:length(H_grid)],grid=:none,label=latexstring("\\frac{\\beta}{\\sigma} = "*string(round(β/σ,digits=2))),xlabel=L"$\widetilde{H^T}$",ylabel=L"$\widetilde{H^T}'$",legend=:topleft)
...
τ_w = d6["τ_w"]
A = d6["A"]
savefig(plt4,"C:/Users/iuliia/Desktop/teachers/julia/results_new/occ_thresh_tauW_"*string(τ_w[1,1])*"_tauE_"*string(τ_e[1,1])*"_A="*string(round(A,digits=2))*".eps")
savefig(plt14,"C:/Users/iuliia/Desktop/teachers/julia/results_new/inv_occ_thresh_tauW_"*string(τ_w[1,1])*"_tauE_"*string(τ_e[1,1])*"_A="*string(round(A,digits=2))*".eps")
savefig(plt5,"C:/Users/iuliia/Desktop/teachers/julia/results_new/frac_teachers_tauW_"*string(τ_w[1,1])*"_tauE_"*string(τ_e[1,1])*"_A="*string(round(A,digits=2))*".eps")
savefig(plt6,"C:/Users/iuliia/Desktop/teachers/julia/results_new/law_of_motion_tauW_"*string(τ_w[1,1])*"_tauE_"*string(τ_e[1,1])*"_A="*string(round(A,digits=2))*".eps")
savefig(plt7,"C:/Users/iuliia/Desktop/teachers/julia/results_new/frac_teachers_by_a_tauW_"*string(τ_w[1,1])*"_tauE_"*string(τ_e[1,1])*"_A="*string(round(A,digits=2))*".eps")
# Plot effect of wedges (τ_w and τ_e) on occupational choice (male vs. female)
d8 = load("C:/Users/iuliia/Desktop/teachers/julia/results_new/results_2_groups_tauW=[0.0 0.0]_tauE=[0.0 0.0]_beta-to-sigma=1.15_A=2.0.jld")
a_grid = d8["a_grid"]
β = d8["β"]
σ = d8["σ"]
f_1 = d8["f_1"]
...
d9 = load("C:/Users/iuliia/Desktop/teachers/julia/results_new/results_2_groups_tauW=[0.1 0.0]_tauE=[0.0 0.0]_beta-to-sigma=1.15_A=2.0.jld")
β = d9["β"]
σ = d9["σ"]
f_1 = d9["f_1"]
f_2 = d9["f_2"]
...
savefig(plt8,"C:/Users/iuliia/Desktop/teachers/julia/results_new/frac_teachers_by_a_tauW_"*string(τ_w[1,1])*"_tauE_"*string(τ_e[1,1])*"_A="*string(round(A,digits=2))*".eps")
d10 = load("C:/Users/iuliia/Desktop/teachers/julia/results_new/results_2_groups_tauW=[0.0 0.0]_tauE=[0.1 0.0]_beta-to-sigma=1.15_A=2.0.jld")
β = d10["β"]
σ = d10["σ"]
f_1 = d10["f_1"]
f_2 = d10["f_2"]
...
savefig(plt9,"C:/Users/iuliia/Desktop/teachers/julia/results_new/frac_teachers_by_a_tauW_"*string(τ_w[1,1])*"_tauE_"*string(τ_e[1,1])*"_A="*string(round(A,digits=2))*".eps")
d11 = load("C:/Users/iuliia/Desktop/teachers/julia/results_new/results_2_groups_tauW=[0.1 0.0]_tauE=[0.1 0.0]_beta-to-sigma=1.15_A=2.0.jld")
β = d11["β"]
σ = d11["σ"]
f_1 = d11["f_1"]
f_2 = d11["f_2"]
...
savefig(plt10,"C:/Users/iuliia/Desktop/teachers/julia/results_new/frac_teachers_by_a_tauW_"*string(τ_w[1,1])*"_tauE_"*string(τ_e[1,1])*"_A="*string(round(A,digits=2))*".eps")
