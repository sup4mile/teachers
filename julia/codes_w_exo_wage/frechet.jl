        ...
        while convT > tolT && iterT < maxiterT
            for iG in 1:n_G
                ...
                function fn_F_T_10p(x)
                    0.1 - quadgk(aa -> spl_f_T[iG](aa), lowbnd, x)[1]
                end
                ...
                function fn_F_T_90p(x)
                    0.9 - quadgk(aa -> spl_f_T[iG](aa), lowbnd, x)[1]
                end
                ...
                for iO = 1:n_O-1
                    ...
                    function fn_F_O_10p(x)
                        ...
                        0.1 - quadgk(aa -> pdf(dist, aa) * spl_f_1_O[iH, iG, iO](aa) / mass_O[iH, iG, iO], lowbnd, x)[1]
                    end
                    ...
                    function fn_F_O_90p(x)
                        ...
                        0.9 - quadgk(aa -> pdf(dist, aa) * spl_f_1_O[iH, iG, iO](aa) / mass_O[iH, iG, iO], lowbnd, x)[1]
                    end
            ...
            function fn_F_T_10p_all_g(x)
                0.1 - quadgk(aa -> fn_f_T_all_g(aa), lowbnd, x)[1]
            end
            function fn_F_T_90p_all_g(x)
                0.9 - quadgk(aa -> fn_f_T_all_g(aa), lowbnd, x)[1]
            end
