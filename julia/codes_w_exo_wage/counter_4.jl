...
# Load parameters and results from previous parameterization:
    cd("./parameterization/counterfactuals/counter_4")
    fyear = string(year)
...
κ = .169 # scale parameter of teachers' wage profile
...
fnameCSV = string("./results/counterfactuals/counter_4/moments",fyear,".csv")
