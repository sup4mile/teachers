...
savefig(plt3_2_70_10,"./plots/A_men_70_10.eps")
# (3.c)
plot!(plt4,a_grid[2:end-2],e_T[2:end-2,iHH,1],label=string(year))
# plot!(plt5,a_grid[2:end-2],e_T[2:end-2,iHH,2],label=string(year))
# (3.e.1)
...
savefig(plt1,"./plots/fT_women_steadystate.eps")
savefig(plt2,"./plots/fT_men_steadystate.eps")
savefig(plt1_1,"./plots/hT_women_steadystate.eps")
savefig(plt2_1,"./plots/hT_men_steadystate.eps")
savefig(plt1_2,"./plots/hT_fT_women_steadystate.eps")
savefig(plt2_2,"./plots/hT_fT_men_steadystate.eps")
savefig(plt3,"./plots/tau_w_women.eps")
savefig(plt3_1_70_90,"./plots/tau_w_women_70_90.eps")
savefig(plt3_1_70_10,"./plots/tau_w_women_70_10.eps")
savefig(plt4,"./plots/eT_steadystate.eps")
savefig(plt6,"./plots/LoM.eps")
savefig(plt7w,"./plots/a_O_women.eps")
savefig(plt7m,"./plots/a_O_men.eps")