...
/* Step C:  Define Key Demographic Variables (employment status, groups, region, education, usual hours worked, etc.) */  
	...
	gen emp_full_lastyear = wkswork2 >= 5 & (incwage + incbus + incfarm) >= 1000 * 38.8/207.16 ;   /*  This is to condition our earnings variables - it restricts sample to those working at least 48 weeks in prior year */
...
/*   Part F:  Save the extract as a new file */ ; 
	...
	#delimit ; 
	save 1970_extract_composite_main, replace ; 
