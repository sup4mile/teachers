...
/* Step C:  Define Key Demographic Variables (employment status, groups, region, education, usual hours worked, etc.) */  
	...
	gen emp_full_lastyear = wkswork1 >= 48 & (incwage + incbus + incfarm) >= 1000 * 82.50/207.16 ;   /*  This is to condition our earnings variables - it restricts sample to those working at least 48 weeks in prior year*/ 


	/*  C2.  Create Sex-Race Groups */ ;
...
/*   Part F:  Save the extract as a new file */ ; 
	...
	#delimit ; 
	save 1980_extract_composite_main, replace ; 
