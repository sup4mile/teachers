...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% EARNINGS (after TauWnext) -- Market Only
...
for g=1:Ngroups;
    ...
    for yrs=1:Nyears;
        IncomeYdata =squeeze(1-TauWnext(Mkt,g,yrs)).*wData(Mkt,yrs) .*squeeze(HAllData(Mkt,g,7-yrs+0,yrs));
        IncomeMdata =squeeze(1-TauWnext(Mkt,g,yrs)).*wData(Mkt,yrs) .*squeeze(HAllData(Mkt,g,7-yrs+1,yrs));
        IncomeOdata =squeeze(1-TauWnext(Mkt,g,yrs)).*wData(Mkt,yrs) .*squeeze(HAllData(Mkt,g,7-yrs+2,yrs));
        IncomeYmodel=squeeze(1-TauWnext(Mkt,g,yrs)).*wModel(Mkt,yrs).*squeeze(HModelAll(Mkt,g,1,yrs));
        IncomeMmodel=squeeze(1-TauWnext(Mkt,g,yrs)).*wModel(Mkt,yrs).*squeeze(HModelAll(Mkt,g,2,yrs));
        IncomeOmodel=squeeze(1-TauWnext(Mkt,g,yrs)).*wModel(Mkt,yrs).*squeeze(HModelAll(Mkt,g,3,yrs));
...
disp ' '; disp ' ';
disp 'ConsumptionYoung (total) per young person in data and model';
