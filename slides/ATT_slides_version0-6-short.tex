...
\documentclass[11pt,hyperref={bookmarks=false},table,aspectratio=169]{beamer}
%\usetheme{Copenhagen}
%\usetheme{default}
\usetheme{default}
...
\setlist[itemize,1]{label=$\blacktriangleright$,} % Default bullet for first level
\setlist[itemize,2]{label=$\bullet$}    % Star for third level
\setlist[itemize,3]{label=$\blacksquare$,label=\rule[0.3ex]{0.7ex}{0.7ex}}  % Diamond for second level
...
\institute[shortinst]{\inst{1} University of Wisconsin--Madison \and \inst{2} Copenhagen Business School}

%\date{Demographics, Health and Inequality Workshop 2026\\ \bigskip March 20, 2026}
\date{\today}
\begin{document}
...
%  \item Introduction
%  \begin{itemize}
%  \item Domestic trends (expenditure, student-teacher ratio,\ldots)
%  \item International comparison (ideally over time; how does evolution of knowledge and skills in the U.S.~compare to other countries?)
%\end{itemize}
%  \item Model
%  \item Data: Project TALENT, NLSY 9 and 97
%  \item Calibration
%  \item Counterfactual experiments
%\end{itemize}
%	\end{frame}
...
%			\begin{itemize}
%				\item Annual real expenditures per student: \$2,100 (1950s) to \$12,000 (2010s)
...
%			\begin{itemize}
%				\item U.S.~education underfunded (compared to other countries) \pause
%				\item Role of teachers' unions (seniority vs.~merit)\pause
%				\item \alert{Occupational choice} (other occupations are more attractive) \pause
%				\item Local funding for public education (e.g.~property taxes) amplifies educational disparities
%			\end{itemize}
%		\end{itemize}
%	\end{frame}
	...
	\begin{frame}
		\frametitle{Introduction}
		\begin{itemize}
\item Motivating Facts
	\begin{itemize}
		\item In the U.S., resources allocated to education have increased significantly since the 1950s
		\item At same time, Improvements in educational achievement have been modest by international standards
	\end{itemize}
\item Research Question
	\begin{itemize}
		...
		\item To what extent are static efficiency gains associated with improved career opportunities in non-teaching occupations muted or amplified by dynamic human capital investment effects?
	\end{itemize}
\end{itemize}
	\end{frame}
...
\begin{frame}
\frametitle{Stylized Facts I}

\begin{columns}[t]
\column{0.45\textwidth}
\alert{Fact \#1: Majority of teachers is female}
		\small{\begin{table}[h!]
			\centering 
			\begin{tabular}{l l c }
				\toprule
		...
		\end{table}}
\column{0.45\textwidth}
\alert{Fact \#2: Women face barriers in (higher) education and in labor markets}
	\small{\begin{itemize}
		\item Women face low barriers / discrimination in teaching
		\item Barriers / discrimination in non-teaching occupations for women generally falling over time
	\end{itemize}}
\end{columns}
\end{frame}

\begin{frame}
\frametitle{Stylized Facts II}

\begin{columns}[t]
\column{0.45\textwidth}
\alert{Fact \#3: Trends in occupational choices}
		\small{\begin{itemize}
			\item Share of teachers in labor force rising between 1970 and 2010
			\begin{itemize}
				\item Share of teachers among women: 3.4\% in 1970, 6.0\% in 2010
				\item Share of teachers among men: 2.6\% in 1970, 1.9\% in 2010
			\end{itemize}
			\item Sharp rise in female labor force participation rate between 1970 and 1990
			\item Slight decline in male labor force participation rate between 1990 and 2010
		\end{itemize}}
\column{0.45\textwidth}
\alert{Fact \#4: Trends in Education Expenditures and Scholastic Achievement}
	\small{\begin{itemize}
		\item Positive relationship between growth in spending per student and improvements in academic performance across high-income nations 1995-2015.%\footnote{Czech Republic, Italy, Mexico, New Zealand, Portugal, Spain, Sweden \& the United States.}\\
		\item Weak relationship for the United States\\(correlation 0.05 vs. 0.28 for other nations).
	\end{itemize}}
\end{columns}
\end{frame}
...
%	\end{frame}
	...
	\begin{frame}
		\frametitle{Stylized Facts III}
		\alert{Fact \#5: Trends in ability distribution of women by occupation}
		\begin{adjustwidth}{2em}{2em}
			\vfill
			\begin{figure}[ht!]
				\begin{subfigure}[b]{0.27\textwidth}
					\centering
					\includegraphics[width=\textwidth]{plots_abilities/raw/TALENT_math_occ_no_norm_female_no_lf.pdf}
				\end{subfigure}
				\hfill
				\begin{subfigure}[b]{0.27\textwidth}
					\centering
					\includegraphics[width=\textwidth]{plots_abilities/raw/nlsy79_mk_occ_no_norm_female_no_lf.pdf}
				\end{subfigure}
				\hfill
				\begin{subfigure}[b]{0.27\textwidth}
					\centering
					\includegraphics[width=\textwidth]{plots_abilities/raw/nlsy97_mk_occ_no_norm_female_no_lf.pdf}
				\end{subfigure}	
				\vfill	
				\begin{subfigure}[b]{0.27\textwidth}
					\centering
					\includegraphics[width=\textwidth]{plots_abilities/raw/TALENT_verbal_occ_no_norm_female_no_lf.pdf}
				\end{subfigure}
				\hfill
				\begin{subfigure}[b]{0.27\textwidth}
					\centering
					\includegraphics[width=\textwidth]{plots_abilities/raw/nlsy79_wk_occ_no_norm_female_no_lf.pdf}
				\end{subfigure}
				\hfill
				\begin{subfigure}[b]{0.27\textwidth}
					\centering
					\includegraphics[width=\textwidth]{plots_abilities/raw/nlsy97_wk_occ_no_norm_female_no_lf.pdf}
				\end{subfigure}	
			\end{figure}
			\vfill
		\end{adjustwidth}
...
%\begin{frame}
%	\frametitle{Stylized Fact \#5}
%		\framesubtitle{Trends in Education Expenditures and Scholastic Achievement: International Comparison}
%	\begin{itemize}
%		\item Positive relationship between growth in spending per student and improvements in academic performance on next test across eight high-income nations 1995-2015.\footnote{Czech Republic, Italy, Mexico, New Zealand, Portugal, Spain, Sweden \& the United States.}\\
%\alert{Weak relationship for the United States (correlation 0.05 vs. 0.28 for other nations).}
%		\item Weak relationship between changes in pupil:teacher ratio and improvements in academic performance on next test.\\ 
%\alert{Similar relationship in US and abroad (correlation 0.06 vs. 0.03 for other nations).}
%	\end{itemize}
%\end{frame}	
%
%\section{Model}	
	...
	\begin{frame}
		\frametitle{Model}
\alert{Three major building blocks:}
		\begin{enumerate}
			\small{\item Two-period OLG model with human capital investment
			\item Agents' occupational choices based on comparative and absolute advantage
			\item Educational barriers / labor market discrimination (as in Hsieh et al., 2019)}
		\end{enumerate}
		
\alert{Novel model elements:}

		{\begin{itemize}
			\small{\item Human capital accumulation in classroom setting:
			\begin{displaymath}
				h'_{i,g}(a_i) =\underbrace{\left( h_{T,\hat{g}} \right)^\beta}_{\textrm{teacher's human capital}} \overbrace{a_i^\alpha}^{\textrm{student's ability}} (s_{i,g})^{\phi} (e_{i,g})^{\eta}\underbrace{\big(N(h_{T,\hat{g}})\big)^{-\sigma}}_{\textrm{class size}}
			\end{displaymath}
			\item Total human capital in teaching $(\tilde{H}_T)$ is aggregate state variable}
			\item Teachers' wages are funded by (local) tax revenue
		\end{itemize}}
	\end{frame}
...
%		\begin{itemize}
%			\item Each period, a measure $\tfrac{M}{2}$ of agents is born and lives for two periods: ``young'' and ``old''
%			\item $G$ groups of individuals indexed by $g \in \{1,\dots,G\}$
%            \item $I$ occupations indexed by $i \in \{1,\dots,I\}$
%			\item Occupational abilities $\vec{a}$ drawn from joint distribution $F(\vec{a})$
%			\item Agents have $\log$ preferences over consumption (tomorrow) and leisure (today):
%			\begin{displaymath}
...
%		\begin{itemize}
%			\item ``Young'' make occupation-specific investments in terms of time ($s$) and goods ($e$)
%			\item ``Old'' work (as \alert{teachers} or \alert{production workers}) and consume
%			%  \item Technologies are occupation-specific:
%			\begin{description}
%				\item[Human capital production] (teaching) depends on\\
%				teacher's human capital $h_{T,\hat{g}}$, class size $N(h_{T,\hat{g}})$,  own ability $a_i$, time $s_{i,g}$ and goods $e_{i,g}$ investments:
%				\begin{align*}
%					\label{}
...
%				\end{align*}
%				\item[Final output production] depends on adult worker's human capital $h_{O,g}$ and exogenous (occupation-specific) productivity $A_O$:
%				\begin{align*}
%					\label{}
%					y_g = A_O h_{O,g}
%				\end{align*}
...
%			& + \mu \ln \Big[ {{h'}_{O,g}} A_O'(1-t')\alert{(1-\tau^{\omega '}_{O,g})}  - e_{O,g}(a_O,\widetilde{H}_T)\alert{(1+\tau^e_{O,g})} \Big],\\
%			%\label{eq:vt}
%			V_{T,g}(a_T,\widetilde{H}_T) & = \ln\left(1-s_{T,g}\left(a_T,\widetilde{H}_T\right)\right) \nonumber \\
%			& + \mu \ln \Big[ \omega_{T,g}'({h_{T,g}'})(1-t')\alert{(1-\tau^{\omega '}_{T,g}) } - e_{T,g}(a_T,\widetilde{H}_T)\alert{(1+\tau^{e }_{T,g})} \Big] 
%		\end{align*}
%	\end{frame}
	
%	\begin{frame}
%		\frametitle{Simple Two-Sector Model}
%		\framesubtitle{Teachers' Compensation Funded by Labor Income Tax $t$}
%		\begin{align*}
%			%H^{T} & = \int_{0}^{\infty} \left(h^{T}(a)\right)^{\frac{\beta}{\sigma}} f^{T}(a) da \\
%			\alert{t}\Bigg[ \sum_{g=1}^G \int_0^\infty (1-\tau^{\omega}_{T,g})\omega_{T,g}\left(h_{T,g}(a)\right) f_{T,g}(a) da  + \sum_{g=1}^G \int_0^\infty (1-\tau^{\omega}_{O,g})A_O h_{O,g}(a) f_{O,g}(a) da \Bigg]\\
%			= \sum_{g=1}^G \int_0^\infty (1-\tau^{\omega}_{T,g})\omega_{T,g}\left(h_{T,g}(a)\right) f_{T,g}(a) da \\
%		\end{align*}
%where
%\begin{displaymath}
%f_{T,g}(a)  = \int_0^{\bar{a}_g^{-1}\left(a\right)} f\big(a,b \big) db \hspace{5mm} \textrm{ \sf and } \hspace{5mm} f_{O,g}(b)  = \int_0^{\bar{a}_g\left(b\right)} f\big(a,b \big) da
%\end{displaymath}
%
...
% \begin{frame}
%		\frametitle{Simple Two-Sector Model}
%		\framesubtitle{Law of Motion for $\tilde{H}_T$}
%		\begin{align*}
...
%		For each $g \in \{1,\ldots,G \}$ and $a_O$, there is a teaching ability $a^*_{T,g}(a_O)$ such that
%%		\begin{equation*}
%%			%\label{eq:ot}
...
%	\begin{frame}
%		\frametitle{Simple Two-Sector Model}
%		\framesubtitle{Assignment of Students to Teachers}
%		%\small
%		%\begin{description}
...
%			%\end{equation*}
%			\begin{itemize}
%				\item Class size is function of teacher's human capital $h_{T,g}$:
%				\begin{align*}
%                    N(h_{T,g})=h_{T,g}^\frac{\beta}{\sigma} \cdot \frac{M}{2\widetilde{H}_T}
%				\end{align*}
%				\item Class size function implies that:
%				\begin{itemize}
%  \item students are indifferent between teachers with different $h_{T,g}$
%  \item assignment of students to teachers is random
%\end{itemize} % \\ $\Rightarrow$ distribution of students' skill identical across classrooms
%				\item Teacher's wage $\omega_{T,g}$ is exogenous function of human capital:
...
\label{eqm}
%\small
Given occupational choices of today's ``old'' and aggregate human capital in teaching $\widetilde{H}_{T}$, an equilibrium consists of individual choices of ``young'' $\{e_{T,g}, s_{T,g}, e_{O,g}, s_{O,g}\}$, the occupational choice boundary $a^*_{T,g}(a_O)$, the corresponding densities $f_{T,g}$ and $f_{O,g}$, and occupation- and group-specific wage profiles $\{\omega_{T,g}, \omega_{O,g}\}$ such that:
\begin{enumerate}
	\item Individuals solve their investment problems \\
	\hyperlink{time_inv}{\beamergotobutton{Time Investment $(s)$}} \hyperlink{good_inv}{\beamergotobutton{Goods Investment $(e)$}}
%	\item Given the laws of motion for idiosyncratic and aggregate human capital, \\
%	\hyperlink{laws}{\beamergotobutton{Aggregate Law of Motion}}
...
%\hfill\hyperlink{stst}{\beamergotobutton{Steady State}} \\
\hfill \hyperlink{laws}{\beamergotobutton{Aggregate Law of Motion}} \\
\hfill \hyperlink{td}{\beamergotobutton{Transition Dynamics}}
\end{frame}
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item NLSY 97
	\end{enumerate}
	\item Respondents' \textit{math}, \textit{verbal}, and \textit{social} abilities based on aptitude tests in all three longitudinal surveys
%	\item 
...
%\framesubtitle{Assumptions, Normalizations, Free Parameters}
%  \footnotesize
%%			\begin{itemize}
...
%			$\tau^{w}_{T,g}=\tau^{e}_{T,g}$ & labor market \& human capital & assumption & 0 \\
%			& barriers in teaching (all groups)&\\
...
%            $A_{21,1970}$ & productivity in ``Home Production'' (1970) & normalization & 1 \\
%	\midrule
%   			$\beta$ & elasticity of student's human capital with & free parameter & 0.5\\
%    &  respect to teacher's human capital & \\
%            $\sigma$ & elasticity of student's human capital with & free parameter & 0.5 \\
...
%			Parameter & Definition & Determination & Value\\
%			\midrule
%			$\theta$ & shape parameter of Fr\'echet-distributed & wage dispersion in non-teaching & 1.476\\
%			& idiosyncratic abilities &  occupations (indirect inference) &\\
%			%					\midrule
%			$\eta$ & goods elasticity of human capital & aggregate education spending share  & 0.103\\
%			& & (indirect inference) &\\
%			%					\midrule
%			$\phi$ & time elasticity of human capital & Mincerian returns to education & 2.745\\
%			& & (non-teaching, indirect inference) &\\
%			%					\midrule
%			$\gamma$ & curvature of wage function in teaching & wage dispersion in teaching & 0.83\\
%			&& (indirect inference) &\\
%			%\midrule
%%			$\beta$ & elasticity of human capital with respect to & arbitrary & 0.5\\
...
%			%					\midrule
%			$\lambda_f$ & composite labor market barrier for women & fraction of females who are teachers \\
...
\begin{frame}
\frametitle{Benchmark Calibration}
\framesubtitle{Evolution of Labor Market Barriers for Women}
%\label{barriers}
%%\hfill \hyperlink{occupations}{\beamergotobutton{List of Occupations}}
%\begin{figure}
%\begin{center}
%\includegraphics[width=\textwidth]{plots/benchmark/tau_w_women_70.png}
%%\caption{ }
%\label{ }
%\end{center}
%\end{figure}
...
%\begin{figure}
%\begin{center}
%\includegraphics[width=\textwidth]{plots/benchmark/tau_w_women_70_90.png}
%%\caption{ }
%\label{ }
%\end{center}
%\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[width=\textwidth]{plots/benchmark/tau_w_women_70_10.png}
%\caption{ }
\label{ }
\end{center}
\end{figure}
...
%\begin{frame}
%\frametitle{Number and Composition of Teachers}
%\begin{figure}
%\begin{center}
%\includegraphics[width=0.65\textwidth]{plots/benchmark/mass_T_over_time.png}
%%\caption{ }
%\label{ }
%\end{center}
%\end{figure}
...
%\begin{frame}
%\frametitle{Occupational Threshold}
%\framesubtitle{Teaching vs.~Home Production, \alert{Men}}
%
%\begin{figure}
% \begin{center}
%\includegraphics[width=0.7\textwidth]{plots/benchmark/a_O_men.png}
% 			\label{ }\\
%		Men with $a_{HP} < a_{HP}^*(a_T)$ become teachers.
% 		\end{center}
% 	\end{figure}
%\end{frame}
%
%\begin{frame}
%\frametitle{Occupational Threshold}
%\framesubtitle{Teaching vs.~Home Production, \alert{Women}}
%
%\begin{figure}
% \begin{center}
%\includegraphics[width=0.7\textwidth]{plots/benchmark/a_O_women.png}
% 			\label{ }\\
%		Women with $a_{HP} < a_{HP}^*(a_T)$ become teachers.
% 		\end{center}
% 	\end{figure}
%\end{frame}
...
\begin{frame}
\frametitle{Benchmark Calibration}
\framesubtitle{Distribution of Teaching Abilities}
\begin{columns}
\column{0.45\textwidth}
\alert{More women with lower abilities become teachers after 1990}
\vfill \begin{figure}
 \begin{center}
\only<1>{\includegraphics[width=0.9\textwidth]{plots/benchmark/fT_unnorm_female.png}
 			\label{ }}
\only<2>{\includegraphics[width=0.9\textwidth]{plots/benchmark/net_flow_teaching_female.png}
 			\label{ }}
 		\end{center}
 	\end{figure}
	\column{0.45\textwidth}
	\alert{Men exit teaching 1970-90, partially return 1990-2010}
	\vfill\begin{figure}
 		\begin{center}
\only<1>{\includegraphics[width=0.9\textwidth]{plots/benchmark/fT_unnorm_male.png}
 			\label{ }}
\only<2>{\includegraphics[width=0.9\textwidth]{plots/benchmark/net_flow_teaching_male.png}
 			\label{ }}
 		\end{center}
 	\end{figure}
	\end{columns}
...
%\framesubtitle{Men exit teaching 1970-90, partially return 1990-2010}
%\begin{figure}
% 		\begin{center}
%\only<1>{\includegraphics[width=0.7\textwidth]{plots/benchmark/fT_unnorm_male.png}
% 			\label{ }}
%\only<2>{\includegraphics[width=0.7\textwidth]{plots/benchmark/net_flow_teaching_male.png}
% 			\label{ }}
% 		\end{center}
% 	\end{figure}
%\end{frame}
...
%\begin{figure}
% 		\begin{center}
% 			\includegraphics[width=0.7\textwidth]{plots/benchmark/eT_steadystate.eps}
% 			%\caption{ }
% 			\label{ }
% 		\end{center}
% 	\end{figure}
...
%\begin{frame}
%\frametitle{Human Capital (relative to 1970)}
%
%\begin{table}
...
%& 1970 & 1990 & 2010 \\
%\midrule
%measure of teachers (female) & 1 & 0.98 & 1.77\\
%measure of teachers (male) & 1 & 0.45 & 0.73\\
%$\widetilde{H}_T$ per teacher (female)   & 1 & 1.44 & 1.38 \\
%$\widetilde{H}_T$ per teacher (male)   & 1 & 2.10 & 2.29 \\
%$\widetilde{H}_T$ (aggregate) & 1  & 1.19 & 2.08 \\
%$H_O$ per worker (female) & 1 & 1.04 & 1.38 \\
%$H_O$ per worker (male) & 1 & 1.35 & 1.99 \\
%$H_O$ (aggregate) & 1 & 1.56 & 2.02\\
%\bottomrule
%\end{tabular}
%%  \caption{ }
%  \label{ }
...
%\begin{frame}\label{benchmark_sum}
%\frametitle{Summing up}
%\begin{itemize}
%    \item Ability distribution and gender composition of teachers changes over time:
%    \begin{itemize}
%		\item More women select teaching, ability distribution becomes more right-skewed (relative to 1970 and relative to men) \hyperlink{density_T_f}{\beamergotobutton{Density Function for Women}}% because other careers are more attractive
%                 \item Fewer men select teaching, distribution becomes (slightly) more left-skewed (relative to 1970) \hyperlink{density_T_m}{\beamergotobutton{Density Function for Men}} % because other careers are more attractive
%    \end{itemize}
%    \item Home production becomes relatively unattractive for women ($\tau_{HP}$ rises sharply between 1970 and 2010):
%    	\begin{itemize}
%  \item Higher-ability women enter non-teaching occupations
%  \item Lower-ability women enter teaching
%  \item Female workers (outside teaching) have 30\% more human capital in 1970, on average, but exhibit less growth over next 40 years compared to male workers
%%  \item W
%\end{itemize}
%%    SUMMARIZE 1970 LEVELS OF HUMAN CAPITAL PER (MEN/WOMEN) AND GROWTH (PER WOMEN/PER MEN/AGGREGATE); TAKE INTO ACCOUNT ENTRY INTO LABOR FORCE
%%    \item Human capital investment drop over time, given ability % because lower ability and lower wages
%    %\item $\Rightarrow$ Lower average teaching human capital 
%%    \item More women become teachers
...
%\end{itemize}
%\hyperlink{cf1}{\beamergotobutton{Jump to Counterfactual \#1}} \hyperlink{cf2}{\beamergotobutton{Jump to Counterfactual \#2}} \hyperlink{conclusion}{\beamergotobutton{Jump to Conclusion}}
%\end{frame}
...
%    \begin{itemize}
%				\item[$\circ$] Women with (relatively) higher ability select into teaching career % because other careers are more attractive
%                \item[$\circ$] Men with (relatively) lower ability select into teaching career % because other careers are more attractive
%    \end{itemize}
%    \item Human capital investment drop over time, given ability % because lower ability and lower wages
%    %\item $\Rightarrow$ Lower average teaching human capital 
...
%\begin{frame}\label{cf1}
%\frametitle{Counterfactual Experiment \#1:\\ Labor Market Barriers for Women Frozen in 1970}
%%\frametitle{Counterfactual Experiment:\\ Labor Market Barriers for Women Frozen in 1970}
%\framesubtitle{Distribution of Teaching Abilities}
%\begin{figure}
% 		\begin{center}
%			\includegraphics[width=0.7\textwidth]{plots/counterfactuals/counter_1/fT_unnorm_female.png}
% 		\end{center}
% 	\end{figure}
%\end{frame}
...
%\begin{frame}
%\frametitle{Counterfactual Experiment \#1:\\ Labor Market Barriers for Women Frozen in 1970}
%\framesubtitle{Density of Teaching Abilities vs.~Benchmark}
%\begin{figure}
% 		\begin{center}
%			\only<1>{\includegraphics[width=0.7\textwidth]{plots/counterfactuals/counter_1/comp_fT_female_1990.png}}
%			\only<2>{\includegraphics[width=0.7\textwidth]{plots/counterfactuals/counter_1/comp_fT_female_2010.png}}
% 		\end{center}
% 	\end{figure}
%\end{frame}
...
%\begin{frame}
%\frametitle{Counterfactual Experiment \#1:\\ Labor Market Barriers for Women Frozen in 1970}
%\framesubtitle{Human Capital: Counterfactual \#1 vs.~Benchmark}
%\begin{table}
%  \centering \begin{tabular}{lccc}
%\toprule
%& 1970 & 1990 & 2010 \\
%\midrule
%measure of teachers (female) & 1 & 0.52 & 0.27\\
%measure of teachers (male) & 1 & 1.08 & 1.11\\
%$\widetilde{H}_T$ per teacher (female)   & 1 & 1.16 & 1.48 \\
%$\widetilde{H}_T$ per teacher (male)   & 1 & 0.80 & 0.67 \\
%$\widetilde{H}_T$ (aggregate) & 1  & 0.71 & 0.53 \\
%\bottomrule
%\end{tabular}
%%  \caption{ }
%  \label{ }
...
\framesubtitle{Comparison with Benchmark Calibration}
\begin{itemize}
  \item Number of teachers and $\widetilde{H}_T$ lower than in benchmark
  \item Ability distribution of female teachers more {\it right}-skewed and women's average $h_T$ higher compared to benchmark
  \item Ability distribution of male teachers more {\it left}-skewed and men's average $h_T$ lower compared to benchmark
\end{itemize}
\end{frame}

%\begin{frame}\label{cf2}
%\frametitle{Counterfactual Experiment \#2:\\ $\kappa$ and Barriers Except \alert{Home Production} Frozen in 1970}
%\framesubtitle{Distribution of Teaching Abilities}
%\begin{figure}
% 		\begin{center}
%			\includegraphics[width=0.7\textwidth]{plots/counterfactuals/counter_5/fT_unnorm_female.png}
% 		\end{center}
% 	\end{figure}
%\end{frame}
%
...
%\begin{figure}
% 		\begin{center}
%			\only<1>{\includegraphics[width=0.7\textwidth]{plots/counterfactuals/counter_5/comp_fT_female_1990.png}}
%			\only<2>{\includegraphics[width=0.7\textwidth]{plots/counterfactuals/counter_5/comp_fT_female_2010.png}}
% 		\end{center}
% 	\end{figure}
%\end{frame}
...
%& 1970 & 1990 & 2010 \\
%\midrule
%measure of teachers (female) & 1 & 2.33 & 1.81\\
%measure of teachers (male) & 1 & 2.4 & 2.13\\
%$\widetilde{H}_T$ per teacher (female)   & 1 & 1.08 & 1.06 \\
%$\widetilde{H}_T$ per teacher (male)   & 1 & 1.16 & 1.02 \\
%$\widetilde{H}_T$ (aggregate) & 1  & 2.61 & 2.02 \\
%\bottomrule
%\end{tabular}
%%  \caption{ }
%  \label{ }
...
\begin{frame}
\frametitle{Counterfactual Experiment \#2: Barriers Except \alert{Home Production} Frozen in 1970}
%\frametitle{Counterfactual Experiment \#2:\\ $\kappa$ and Barriers Except \alert{Home Production} Frozen in 1970}
\framesubtitle{Summing Up}
\framesubtitle{Comparison with Benchmark Calibration}
\begin{itemize}
  \item Number of teachers (male and female) and $\widetilde{H}_T$ higher than in benchmark
  \item Average $h_T$ of teachers similar to benchmark
  \item Ability distribution of all teachers more {\it right}-skewed compared to benchmark
\end{itemize}
\end{frame}
...
%	\frametitle{Conclusion}
	...
	%\framesubtitle{}
%\only<1>{\textcolor{tblue}{Results}
%	\begin{itemize}
%		\item Develop a novel theory of occupational choice and human capital formation: 
%		\begin{itemize}
%			\item non-linear wages %$\Rightarrow$ comparative and absolute advantage
%			\item intergenerational dynamics of human capital accumulation
%		\end{itemize}
%		\item Quantitative model characterizes compositional changes in abilities at occupation level
%	\end{itemize}}
%\only<2>{\textcolor{tblue}{Ongoing and Future Work}
	\begin{itemize}	
		\item More granular decomposition of labor productivity growth into selection and human capital investment effects
		\item Disentangle role of $\tilde{H}_T$ and individual teachers' $h_T$ more sharply
		\item Quantify extent of occupational mismatch using aptitude test scores in Project TALENT, NLSY79, NLSY97, and occupational skill requirements in O*NET
		\item Explore effect of competition for teaching talent across multiple locations / school districts (differentiated by amenities)
	\end{itemize}
\end{frame}

\begin{frame}\label{LoMplot}
\frametitle{Aggregate Law of Motion}
\begin{figure}
\begin{center}
\includegraphics[width=0.7\textwidth]{plots/benchmark/LoM.png}
%\caption{ }
\label{ }
\end{center}
\end{figure}
\hfill \hyperlink{eqm}{\beamerreturnbutton{Back}}
\end{frame}
...
\begin{frame}
	...
	\begin{align}
		%\label{eq:lomT}
		\widetilde{H}'_{T} & = \Bigg[ \left(\kappa \cdot \gamma \cdot \eta\right)^{\frac{\eta}{1-\eta\gamma}} \cdot \left(\tfrac{2\widetilde{H}_T}{M}\right)^{\frac{\sigma}{1-\eta\gamma}} \times \sum_{g=1}^G \tau_{T,g}^\frac{\eta}{1-\eta\gamma} \cdot \int_0^\infty  s_{T,g}^\frac{\phi}{1-\eta\gamma} \cdot a^\frac{\alpha}{1-\eta\gamma}  f_{T,g}(a)da \Bigg]^\frac{\beta}{\sigma} \nonumber  
	\end{align}
...
%		{H}'_{O} & = \left({A'}_O \cdot \eta\right)^\frac{\eta}{1-\eta} \cdot \left(\tfrac{2\widetilde{H}_T}{M}\right)^\frac{\sigma}{1-\eta} \cdot  \sum_{g=1}^G \tau_{O,g}^\frac{\eta}{1-\eta} \cdot \int_0^\infty s_{O,g}^\frac{\phi}{1-\eta} \cdot a^{\frac{\alpha}{1-\eta}} f_{O,g}(a)da \nonumber
	...
	\begin{align}
		\tau_{i,g} & =\frac{(1-t)(1-\tau^{\omega}_{i,g})}{1+\tau^e_{i,g}} \nonumber
	\end{align}
%	\hfill \hyperlink{LoMplot}{\beamergotobutton{Plot}}\\
	\hfill \hyperlink{eqm}{\beamerreturnbutton{Back}}
\end{frame}

\begin{frame}\label{td}
\frametitle{Transition Dynamics}
\begin{itemize}
  \item Occupational choice boundary depends on $\widetilde{H}_T$:
  \begin{align*}
	\frac{\alert{{a}_{T,g}^*(a_O)}^\frac{\alpha}{\frac{1}{\gamma}-\eta}}{a_O^\frac{\alpha}{1-\eta}} \cdot \frac{s_{T,g}^\frac{\phi}{\frac{1}{\gamma}-\eta}}{s_{O,g}^\frac{\phi}{1-\eta}}\cdot \frac{\tau_{T,g}^\frac{1}{1-\eta\gamma}}{\tau_{O,g}^\frac{1}{1-\eta}} \cdot \frac{1+\tau^e_{T,g}}{1+\tau^e_{O,g}}\cdot \left(\frac{1-s_{T,g}}{1-s_{O,g}}\right)^\frac{1}{\mu} \nonumber\\
...
\begin{align}
	\tau_{i,g} =\frac{(1-t)(1-\tau^{\omega}_{i,g})}{1+\tau^e_{i,g}} \nonumber
\end{align}
  \item Relationship between $\widetilde{H}_T$ and ${a}_{T,g}^*(a_O)$ ``drives'' transition dynamics \hfill \hyperlink{eqm}{\beamerreturnbutton{Back}}
\end{itemize}
%\footnotesize
\end{frame}

%\begin{frame}\label{stst}
...
%\begin{frame}\label{density_T_f}
%\frametitle{Density Function for Ability of Female Teachers}
%\begin{figure}
%\begin{center}
%\includegraphics[width=0.7\textwidth]{plots/benchmark/fT_female_steadystate.png}
%%\caption{ }
%%\label{ }
%\end{center}
%\end{figure}
%\hfill \hyperlink{benchmark_sum}{\beamerreturnbutton{Back}}
%\end{frame}
%
%\begin{frame}\label{density_T_m}
%\frametitle{Density Function for Ability of Male Teachers}
%\begin{figure}
%\begin{center}
%\includegraphics[width=0.7\textwidth]{plots/benchmark/fT_male_steadystate.png}
%%\caption{ }
%%\label{ }
%\end{center}
%\end{figure}
...
\begin{frame}
	\frametitle{List of Occupations} 
	\label{occupations}
 \tiny
	\begin{enumerate}
...
\hfill	\hyperlink{barriers3}{\beamerreturnbutton{Back}}
\end{frame}
...
\begin{figure}
\begin{center}
%\includegraphics[width=0.8\textwidth]{plots/counter_2/fT_women_steadystate.eps}
%\caption{ }
\label{ }
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
%\includegraphics[width=0.8\textwidth]{plots/counterfactuals/counter_2/fT_men_steadystate.eps}
%\caption{ }
\label{ }
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
%\includegraphics[width=0.8\textwidth]{plots/counterfactuals/counter_2/eT_steadystate.eps}
%\caption{ }
\label{ }
\end{center}
\end{figure}
