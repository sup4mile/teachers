...
%					\includegraphics[width=\textwidth]{plots/nlsy97_wk_occ_no_norm_female_no_lf.pdf}
	...
	\begin{frame}
		...
		\begin{align*}
			...
			= \sum_{g=1}^G\int_0^\infty \omega_T\left(h_{T,g}(a)\right) f_{T,g}(a) da \\%\frac{2}{M} \int_0^\infty \omega\left(h^{T'}(a)\right) {f'}^T(a) da \nonumber\\
	...
	\begin{frame}
		...
		\begin{frame}
			...
			\end{enumerate}
			\hyperlink{wage}{\beamergotobutton{Wage Profile}} \hyperlink{param}{\beamergotobutton{Parameter Restrictions}}
		\end{frame}
