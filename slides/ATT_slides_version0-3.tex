...
\begin{document}
	...
	\begin{frame}
		...
		\begin{align*}
			...
			\alert{t}\left[ \sum_{g=1}^G \int_0^\infty \omega_{T,g}\left(h_{T,g}(a)\right) f_{T,g}(a) da  +  \sum_{g=1}^G \int_0^\infty A_O h_{O,g}(a) f_{O,g}(a) da \right]  \\
			= \sum_{g=1}^G \int_0^\infty\omega_{T,g}\left(h_{T,g}(a)\right) f_{T,g}(a) da \\
