...
\end{frame}
 ...
 \section{Stylized Facts}
	...
	\begin{frame}
		...
		\framesubtitle{Trends in Ability Distribution of Women by Occupation}
		\begin{adjustwidth}{2em}{2em}
			\vfill
			\begin{figure}[ht!]
...
\begin{frame}
		...
		\begin{enumerate}
			\item Two-period OLG model with human capital investment
...
\framesubtitle{More women with lower abilities become teachers after 1990}
\begin{figure}
 \begin{center}
\only<1>{\includegraphics[width=0.7\textwidth]{plots/benchmark/fT_unnorm_female.png}
 			\label{ }}
\only<2>{\includegraphics[width=0.7\textwidth]{plots/benchmark/net_flow_teaching_female.png}
 			\label{ }}
 		\end{center}
 	\end{figure}
\end{frame}
