...
t\Bigg[ \sum_{g=1}^G \int_0^\infty \omega_T\left(h_{T,g}(a)\right) f_{T,g}(a) da & \nonumber\\
 +  \sum_{g=1}^G \int_0^\infty \omega_O\left(h_{O,g}(a)\right) f_{O,g}(a) da \Bigg] & =  \sum_{g=1}^G\int_0^\infty \omega_T\left(h_{T,g}(a)\right) f_{T,g}(a) da \label{eq:bc}%\frac{2}{M} \int_0^\infty \omega\left(h^{T'}(a)\right) {f'}^T(a) da \nonumber\\
...
\begin{align}
\label{eq:foc-e}
(1+\tau^e_{T,g}) e_{T,g} \left( \tfrac{\sigma}{\eta\beta }-1 \right) & = \left(1-s_{T,g}\right) \mu(1-t')(1-\tau^{\omega '}_{T,g}) \cdot \tfrac{\partial \omega'}{\partial h'_{T,g}} \cdot \tfrac{\partial h'_{T,g}}{\partial s_{T,g}}\\
\label{eq:foc-s}
1+\tau^e_{T,g} & = (1-t')(1-\tau^{\omega '}_{T,g})\cdot \tfrac{\partial \omega'}{\partial h'_{T,g}}\cdot \tfrac{\partial h'_{T,g}}{\partial e_{T,g}},
\end{align}
...
\begin{align}
\label{eq:s_T}
s_{T,g} & = \frac{\mu \phi}{\mu \phi+\eta \cdot \tau_{T,g} \cdot \tfrac{\omega '(h'_{T,g})}{e_{T,g}}-\eta} \\
\label{eq:e_T}
