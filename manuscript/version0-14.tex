...
We can show that this economy has a steady state in $\widetilde{H}_T$ and we can characterize it in a single equation:%\footnote{When the economy has $I>2$ occupations, the steady state $H_T$ is characterized by:
%\begin{align*}
%\label{eq:lomT}
%\widetilde{H}_{T} & = 
%\end{align*}
...
We focus on the verbal composite score and math composite score provided by Project TALENT. In addition, we construct noncognitive ability which we call social ability hereafter by combining scores on impulsiveness, calmness, self-confidence, mature personality applying principal component analysis (PCA). Finally, we convert these scores into percentile ranks among individuals (NOT IN THE TABLE). 
