...
%\label{eq:e_T}
e_{T,g} & = \left( \tau_{T,g}\cdot \eta \cdot\left(\tfrac{2 \widetilde{H}_T}{M}\right)^\sigma \cdot\left(\tfrac{\partial \omega'}{\partial h'_{T,g}}\right) \cdot s_{T,g}^\phi \cdot a_T^\alpha \right)^{\frac{1}{1-\eta}}
\end{align}
